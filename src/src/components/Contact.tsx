...
export default function Contact() {
  ...
  return (
    <section id="contact" className="snap-section flex items-center px-6">
      <div ref={ref} className="max-w-xl mx-auto text-center">
        ...
        <div className={`fade-up ${isVisible ? "visible" : ""}`} style={{ transitionDelay: "0.15s" }}>
          ...
          <a
            href="mailto:elliott.e.cho@vanderbilt.edu"
            className="inline-block px-8 py-3.5 bg-accent text-white text-sm font-medium rounded-lg hover:bg-accent/90 transition-all glow"
          >
            Say Hello
          </a>
          ...
          <div className="mt-14 flex items-center justify-center gap-8">
            <a
              href="https://linkedin.com/in/elliotteycho"
              target="_blank"
            ...
            <a
              href="https://github.com/elliotteycho"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted/50 hover:text-accent transition-colors duration-300"
              aria-label="GitHub"
          ...
          <p className="mt-16 text-[10px] text-muted/30 font-mono">
